      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-rose-400 bg-clip-text text-transparent mb-4">
              Anabeya Collection
            </h3>
            <p className="text-gray-300 mb-6 max-w-md">
              Discover unique, handmade clothing pieces crafted with love and attention to detail. 
              Each item in our collection tells a story of creativity and quality craftsmanship.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-300">contact@anabeya.com</span>
            </div>
            <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 Anabeya Collection. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
